...
export const DEFAULT_RULES: RuleDefinition[] = [
  ...
  { rank: 'K', label: "Make a Rule / King's Cup", prompt: "Make a rule everyone must follow. Break it = drink. Pour alcohol into the King's Cup. Person who draws the 4th King drinks!" },
];
